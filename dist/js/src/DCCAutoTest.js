...
import { DCCClientFS_NodeJS } from '../assets/LayaDCC/common/DCCClientFS_NodeJS.js';
import { LayaDCC, Params } from '../assets/LayaDCC/common/LayaDCC.js';
import { LayaDCCClient } from '../assets/LayaDCC/common/LayaDCCClient.js';
import AdmZip from "adm-zip";
import * as fs from 'fs';
import * as path from "path";
import { Zip_Native } from '../assets/LayaDCC/common/Zip_Native.js';
import { Zip_Nodejs } from './Zip_NodeJS.js';
import { DccDiffer } from '../assets/LayaDCC/common/LayaDCCDiffer.js';
import { PackRaw } from '../assets/LayaDCC/ExpTools/DCCPackWriters.js';
function verify(v, desc) {
    if (!v)
        throw desc;
...
], DCCAutoTest.prototype, "testDCC", null);
__decorate([
    IEditor.onLoad
], DCCAutoTest, "init1", null);
...
async function testZip() {
    ...
    let headAfterUpdate = await client.fileIO.read('head.json', 'utf8', true, null);
...
async function updateByPack() {
    let packfile = await LayaDCCTools.genPackByFileList(['D:/work/ideproj/DCCPlugin/release/web/internal/Box.lm',
...
async function testDiff() {
    ...
    let diff = await DccDiffer.getDiff(Editor.projectPath + '/dcctest/dccout/version.2.0.0.json', Editor.projectPath + '/dcctest/dccout/version.3.0.0.json');
